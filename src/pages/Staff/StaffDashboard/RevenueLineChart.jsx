...
const RevenueLineChart = ({ recentOrders, loading, error }) => {
  ...
  return (
    <div>
      <div className="d-flex align-items-center mb-3">
        <h5 className="mb-0 flex-grow-1">Biểu đồ doanh thu</h5>
        <Form.Select
      ...
      {loading ? (
        ...
        <ResponsiveContainer width="100%" height={300}>
          <LineChart data={chartData} margin={{ top: 5, right: 30, left: 10, bottom: 5 }}>
            ...
            <Legend />
            <Line type="monotone" dataKey="revenue" stroke="#82ca9d" strokeWidth={2} activeDot={{ r: 8 }} name="Doanh thu (₫)" />
          </LineChart>
        </ResponsiveContainer>
      )}
    </div>
